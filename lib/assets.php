...
function assets() {
  ...
  wp_enqueue_style('google_fonts', '//fonts.googleapis.com/css?family=Raleway:400', false, null);
  ...
  wp_enqueue_script('google_maps', '//maps.googleapis.com/maps/api/js?key=AIzaSyC_bzQmWRwDjeBflq715-Yxk691hpDgABQ', ['jquery'], null, true);
